import { AsyncReducer, Reducer } from '@codibre/fluent-iterable';
...
export interface ReduceFunction {
   ...
   */
  <T, R>(reducer: Reducer<T, R>, initial: R): Expression<Iterable<T>, R>;
}

export interface AsyncReduceFunction {
  /**
   ...
   */
  <T, R>(reducer: AsyncReducer<T, R>, initial: R): AsyncExpression<
    Iterable<T>,
    R
  >;
}
